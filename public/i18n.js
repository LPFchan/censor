...
(() => {
  const english = {
    ...
    agentLink: 'point your agent at it →',
    agentDialogTitle: 'use censor from your agent',
    agentDialogSub: 'paste this into your agent to give it image-censoring tools:',
  ...
  const coreKeys = [
    'title', 'tagline', 'privacy', 'openImage', 'loadClipboard',
  ...
  const coreRows = {
    ar: ['censor — محرر التمويه والفسيفساء','موّه أجزاء من الصورة أو حوّلها إلى بكسلات.','كل شيء يبقى على جهازك.','فتح صورة','تحميل من الحافظة','فسيفساء','تمويه','فرشاة','حذف العنصر','تم','مربع (M)','رسم حر (B)','تحريك / نقل العناصر (V)','تراجع','إعادة','ملاءمة للشاشة','مسح الكل','صورة جديدة','نسخ الصورة الناتجة','حفظ الصورة','أفلت الصورة لفتحها'],
    bn: ['censor — ব্লার ও মোজাইক সম্পাদক','ছবির কিছু অংশ ব্লার বা পিক্সেল করুন।','সবকিছু আপনার ডিভাইসেই থাকে।','ছবি খুলুন','ক্লিপবোর্ড থেকে লোড করুন','মোজাইক','ব্লার','ব্রাশ','বস্তু মুছুন','সম্পন্ন','বাক্স (M)','মুক্তহস্ত (B)','প্যান / বস্তু সরান (V)','পূর্বাবস্থা','পুনরায়','স্ক্রিনে মানান','সব মুছুন','নতুন ছবি','আউটপুট ছবি কপি করুন','ছবি সংরক্ষণ করুন','খুলতে ছবি ছাড়ুন'],
    cs: ['censor — editor rozmazání a mozaiky','Rozmažte nebo rozpixelujte části fotografie.','Vše zůstává ve vašem zařízení.','otevřít obrázek','načíst ze schránky','mozaika','rozmazání','štětec','odstranit objekt','hotovo','rámeček (M)','volná kresba (B)','posun / přesun objektů (V)','zpět','znovu','přizpůsobit obrazovce','vymazat vše','nový obrázek','kopírovat výsledný obrázek','uložit obrázek','přetažením otevřete obrázek'],
    ...
    de: ['censor — Weichzeichner- & Mosaikeditor','Bereiche eines Fotos weichzeichnen oder verpixeln.','Alles bleibt auf deinem Gerät.','Bild öffnen','aus Zwischenablage laden','Mosaik','Weichzeichnen','Pinsel','Objekt löschen','fertig','Rechteck (M)','Freihand (B)','Ansicht / Objekte verschieben (V)','rückgängig','wiederholen','an Bildschirm anpassen','alles löschen','neues Bild','Ausgabebild kopieren','Bild speichern','Bild zum Öffnen ablegen'],
    el: ['censor — επεξεργασία θόλωσης και μωσαϊκού','Θολώστε ή εικονοστοιχειοποιήστε μέρη μιας φωτογραφίας.','Όλα παραμένουν στη συσκευή σας.','άνοιγμα εικόνας','φόρτωση από πρόχειρο','μωσαϊκό','θόλωση','πινέλο','διαγραφή αντικειμένου','τέλος','πλαίσιο (M)','ελεύθερο σχέδιο (B)','μετατόπιση / μετακίνηση αντικειμένων (V)','αναίρεση','επανάληψη','προσαρμογή στην οθόνη','εκκαθάριση όλων','νέα εικόνα','αντιγραφή εικόνας εξόδου','αποθήκευση εικόνας','αφήστε την εικόνα για άνοιγμα'],
    es: ['censor — editor de desenfoque y mosaico','Desenfoca o pixela partes de una foto.','Todo permanece en tu dispositivo.','abrir una imagen','cargar del portapapeles','mosaico','desenfoque','pincel','eliminar objeto','listo','cuadro (M)','mano alzada (B)','desplazar / mover objetos (V)','deshacer','rehacer','ajustar a pantalla','borrar todo','nueva imagen','copiar imagen resultante','guardar imagen','suelta la imagen para abrirla'],
    fa: ['censor — ویرایشگر محو و موزاییک','بخش‌هایی از عکس را محو یا پیکسلی کنید.','همه‌چیز روی دستگاه شما می‌ماند.','باز کردن تصویر','بارگیری از کلیپ‌بورد','موزاییک','محو','قلم‌مو','حذف شیء','تمام','کادر (M)','طراحی آزاد (B)','حرکت نما / اشیاء (V)','واگرد','از نو','جا دادن در صفحه','پاک کردن همه','تصویر جدید','کپی تصویر خروجی','ذخیره تصویر','برای باز کردن، تصویر را رها کنید'],
    fi: ['censor — sumennus- ja mosaiikkieditori','Sumenna tai pikselöi kuvan osia.','Kaikki pysyy laitteellasi.','avaa kuva','lataa leikepöydältä','mosaiikki','sumennus','sivellin','poista kohde','valmis','laatikko (M)','vapaapiirto (B)','panoroi / siirrä kohteita (V)','kumoa','tee uudelleen','sovita näyttöön','tyhjennä kaikki','uusi kuva','kopioi tuloskuva','tallenna kuva','avaa pudottamalla kuva'],
    fr: ['censor — éditeur de flou et mosaïque','Floutez ou pixellisez certaines parties d’une photo.','Tout reste sur votre appareil.','ouvrir une image','charger depuis le presse-papiers','mosaïque','flou','pinceau','supprimer l’objet','terminé','cadre (M)','main levée (B)','déplacer la vue / les objets (V)','annuler','rétablir','ajuster à l’écran','tout effacer','nouvelle image','copier l’image produite','enregistrer l’image','déposez l’image pour l’ouvrir'],
    he: ['censor — עורך טשטוש ופסיפס','טשטשו או פקסלו חלקים מתמונה.','הכול נשאר במכשיר שלך.','פתיחת תמונה','טעינה מהלוח','פסיפס','טשטוש','מברשת','מחיקת אובייקט','סיום','תיבה (M)','ציור חופשי (B)','הזזה / העברת אובייקטים (V)','ביטול','ביצוע חוזר','התאמה למסך','ניקוי הכול','תמונה חדשה','העתקת תמונת הפלט','שמירת תמונה','שחררו תמונה כדי לפתוח'],
    hi: ['censor — ब्लर और मोज़ेक संपादक','फ़ोटो के हिस्सों को धुंधला या पिक्सेलयुक्त करें।','सब कुछ आपके डिवाइस पर रहता है।','चित्र खोलें','क्लिपबोर्ड से लोड करें','मोज़ेक','ब्लर','ब्रश','ऑब्जेक्ट हटाएँ','पूर्ण','बॉक्स (M)','मुक्तहस्त (B)','पैन / ऑब्जेक्ट खिसकाएँ (V)','पूर्ववत','फिर करें','स्क्रीन में फ़िट करें','सब साफ़ करें','नया चित्र','आउटपुट चित्र कॉपी करें','चित्र सहेजें','खोलने के लिए चित्र छोड़ें'],
    id: ['censor — editor buram & mosaik','Buramkan atau pikselkan bagian foto.','Semuanya tetap di perangkat Anda.','buka gambar','muat dari papan klip','mosaik','buram','kuas','hapus objek','selesai','kotak (M)','gambar bebas (B)','geser / pindahkan objek (V)','urungkan','ulangi','paskan ke layar','hapus semua','gambar baru','salin gambar hasil','simpan gambar','lepaskan gambar untuk membuka'],
    it: ['censor — editor sfocatura e mosaico','Sfoca o pixella parti di una foto.','Tutto rimane sul tuo dispositivo.','apri un’immagine','carica dagli appunti','mosaico','sfocatura','pennello','elimina oggetto','fatto','riquadro (M)','mano libera (B)','sposta vista / oggetti (V)','annulla','ripeti','adatta allo schermo','cancella tutto','nuova immagine','copia immagine risultante','salva immagine','rilascia l’immagine per aprirla'],
    ja: ['censor — ぼかし・モザイク編集','写真の一部をぼかしたりモザイクにしたりできます。','画像はすべて端末内に保存されます。','画像を開く','クリップボードから読み込む','モザイク','ぼかし','ブラシ','オブジェクトを削除','完了','四角形 (M)','フリーハンド (B)','表示 / オブジェクトを移動 (V)','元に戻す','やり直す','画面に合わせる','すべて消去','新しい画像','出力画像をコピー','画像を保存','画像をドロップして開く'],
    ko: ['censor — 흐림 및 모자이크 편집기','사진의 일부를 흐리게 하거나 모자이크 처리하세요.','모든 작업은 기기에만 저장됩니다.','이미지 열기','클립보드에서 불러오기','모자이크','흐림','브러시','개체 삭제','완료','상자 (M)','자유 그리기 (B)','화면 / 개체 이동 (V)','실행 취소','다시 실행','화면에 맞추기','모두 지우기','새 이미지','결과 이미지 복사','이미지 저장','이미지를 놓아 열기'],
    ms: ['censor — penyunting kabur & mozek','Kaburkan atau pikselkan bahagian foto.','Semuanya kekal pada peranti anda.','buka imej','muat dari papan klip','mozek','kabur','berus','padam objek','selesai','kotak (M)','lukisan bebas (B)','sorot / alih objek (V)','buat asal','buat semula','muat pada skrin','kosongkan semua','imej baharu','salin imej output','simpan imej','lepaskan imej untuk membuka'],
    nl: ['censor — vervagings- en mozaïekeditor','Vervaag of pixel delen van een foto.','Alles blijft op je apparaat.','afbeelding openen','laden van klembord','mozaïek','vervagen','penseel','object verwijderen','klaar','vak (M)','vrije hand (B)','beeld / objecten verplaatsen (V)','ongedaan maken','opnieuw','passend op scherm','alles wissen','nieuwe afbeelding','uitvoerafbeelding kopiëren','afbeelding opslaan','zet afbeelding neer om te openen'],
    no: ['censor — uskarphets- og mosaikkredigering','Gjør deler av et bilde uskarpe eller pikselerte.','Alt blir på enheten din.','åpne et bilde','last fra utklippstavlen','mosaikk','uskarphet','pensel','slett objekt','ferdig','boks (M)','frihånd (B)','panorer / flytt objekter (V)','angre','gjør om','tilpass til skjermen','tøm alt','nytt bilde','kopier resultatbildet','lagre bilde','slipp bildet for å åpne'],
    pl: ['censor — edytor rozmycia i mozaiki','Rozmyj lub spikselizuj fragmenty zdjęcia.','Wszystko pozostaje na Twoim urządzeniu.','otwórz obraz','wczytaj ze schowka','mozaika','rozmycie','pędzel','usuń obiekt','gotowe','prostokąt (M)','odręcznie (B)','przesuń widok / obiekty (V)','cofnij','ponów','dopasuj do ekranu','wyczyść wszystko','nowy obraz','kopiuj obraz wynikowy','zapisz obraz','upuść obraz, aby otworzyć'],
    pt: ['censor — editor de desfoque e mosaico','Desfoque ou pixelize partes de uma foto.','Tudo permanece no seu dispositivo.','abrir uma imagem','carregar da área de transferência','mosaico','desfoque','pincel','excluir objeto','concluir','caixa (M)','mão livre (B)','mover vista / objetos (V)','desfazer','refazer','ajustar à tela','limpar tudo','nova imagem','copiar imagem resultante','salvar imagem','solte a imagem para abrir'],
    ro: ['censor — editor de estompare și mozaic','Estompați sau pixelizați părți dintr-o fotografie.','Totul rămâne pe dispozitivul dvs.','deschide o imagine','încarcă din clipboard','mozaic','estompare','pensulă','șterge obiectul','gata','casetă (M)','desen liber (B)','panoramare / mutare obiecte (V)','anulează','refă','potrivește pe ecran','șterge tot','imagine nouă','copiază imaginea rezultată','salvează imaginea','plasați imaginea pentru a o deschide'],
    ru: ['censor — редактор размытия и мозаики','Размывайте или пикселизируйте части фотографии.','Всё остаётся на вашем устройстве.','открыть изображение','загрузить из буфера обмена','мозаика','размытие','кисть','удалить объект','готово','прямоугольник (M)','от руки (B)','панорама / перемещение объектов (V)','отменить','повторить','вписать в экран','очистить всё','новое изображение','копировать результат','сохранить изображение','перетащите изображение, чтобы открыть'],
    sv: ['censor — oskärpe- och mosaikredigerare','Gör delar av ett foto suddiga eller pixliga.','Allt stannar på din enhet.','öppna en bild','läs in från urklipp','mosaik','oskärpa','pensel','ta bort objekt','klar','ruta (M)','frihand (B)','panorera / flytta objekt (V)','ångra','gör om','anpassa till skärmen','rensa allt','ny bild','kopiera resultatbild','spara bild','släpp bilden för att öppna'],
    th: ['censor — เครื่องมือเบลอและโมเสก','เบลอหรือทำภาพเป็นพิกเซลเฉพาะส่วน','ทุกอย่างอยู่บนอุปกรณ์ของคุณ','เปิดรูปภาพ','โหลดจากคลิปบอร์ด','โมเสก','เบลอ','แปรง','ลบวัตถุ','เสร็จ','กรอบ (M)','วาดอิสระ (B)','เลื่อน / ย้ายวัตถุ (V)','เลิกทำ','ทำซ้ำ','พอดีหน้าจอ','ล้างทั้งหมด','รูปภาพใหม่','คัดลอกรูปผลลัพธ์','บันทึกรูปภาพ','วางรูปเพื่อเปิด'],
    tr: ['censor — bulanıklık ve mozaik düzenleyici','Fotoğrafın bölümlerini bulanıklaştırın veya pikselleştirin.','Her şey cihazınızda kalır.','görsel aç','panodan yükle','mozaik','bulanıklık','fırça','nesneyi sil','bitti','kutu (M)','serbest çizim (B)','kaydır / nesneleri taşı (V)','geri al','yinele','ekrana sığdır','tümünü temizle','yeni görsel','çıktı görselini kopyala','görseli kaydet','açmak için görseli bırakın'],
    uk: ['censor — редактор розмиття й мозаїки','Розмивайте або пікселізуйте частини фотографії.','Усе залишається на вашому пристрої.','відкрити зображення','завантажити з буфера обміну','мозаїка','розмиття','пензель','видалити об’єкт','готово','прямокутник (M)','від руки (B)','панорама / переміщення об’єктів (V)','скасувати','повторити','підігнати до екрана','очистити все','нове зображення','копіювати результат','зберегти зображення','перетягніть зображення, щоб відкрити'],
    ur: ['censor — دھندلا اور موزیک ایڈیٹر','تصویر کے حصوں کو دھندلا یا پکسل کریں۔','سب کچھ آپ کے آلے پر رہتا ہے۔','تصویر کھولیں','کلپ بورڈ سے لوڈ کریں','موزیک','دھندلا','برش','شے حذف کریں','مکمل','خانہ (M)','آزادانہ (B)','منظر / اشیا منتقل کریں (V)','واپس','دوبارہ','اسکرین پر فٹ کریں','سب صاف کریں','نئی تصویر','نتیجہ تصویر کاپی کریں','تصویر محفوظ کریں','کھولنے کے لیے تصویر چھوڑیں'],
    vi: ['censor — trình chỉnh sửa làm mờ & khảm','Làm mờ hoặc tạo điểm ảnh cho một phần ảnh.','Mọi thứ đều ở lại trên thiết bị của bạn.','mở ảnh','tải từ bảng nhớ tạm','khảm','làm mờ','cọ','xóa đối tượng','xong','khung (M)','vẽ tự do (B)','di chuyển khung nhìn / đối tượng (V)','hoàn tác','làm lại','vừa màn hình','xóa tất cả','ảnh mới','sao chép ảnh kết quả','lưu ảnh','thả ảnh để mở'],
    'zh-hans': ['censor — 模糊与马赛克编辑器','模糊或像素化照片的部分区域。','所有内容都保留在你的设备上。','打开图片','从剪贴板加载','马赛克','模糊','画笔','删除对象','完成','矩形 (M)','自由绘制 (B)','平移 / 移动对象 (V)','撤销','重做','适应屏幕','全部清除','新图片','复制输出图片','保存图片','拖放图片以打开'],
    'zh-hant': ['censor — 模糊與馬賽克編輯器','模糊或像素化照片的部分區域。','所有內容都保留在你的裝置上。','開啟圖片','從剪貼簿載入','馬賽克','模糊','筆刷','刪除物件','完成','矩形 (M)','自由繪製 (B)','平移 / 移動物件 (V)','復原','重做','符合螢幕','全部清除','新圖片','複製輸出圖片','儲存圖片','拖放圖片以開啟'],
  };
