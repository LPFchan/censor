...
// Cloudflare Workers port: pako arrives as an ES module import via
// globalThis.__censorPako (set by png.js before this file is evaluated).
// There is no require() or window in this runtime.
// Resolved lazily: png.js assigns the global after this UMD body runs
// (import hoisting), but always before any decode/encode call.
var pako;
function getPako() { return pako || (pako = globalThis.__censorPako); }
function log() { if (typeof process=="undefined" || process.env.NODE_ENV=="development") console.log.apply(console, arguments);  }
(function(UPNG, pako){
	globalThis.__censorUPNG = UPNG;
...
UPNG.decode._inflate = function(data) {  return getPako()["inflate"](data);  }
...
UPNG.encode._filterZero = function(img,h,bpp,bpl,data)
{
	...
	for(var t=0; t<5; t++) {  if(h*bpl>500000 && (t==2 || t==3 || t==4)) continue;
		...
		fls.push(getPako()["deflate"](data));  if(bpp==1) break;
	}
	var ti, tsize=1e9;
...
export default globalThis.__censorUPNG;
